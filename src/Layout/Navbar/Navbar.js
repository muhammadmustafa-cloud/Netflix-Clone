    ...
    <div className="bg-main shadow.md sticky top-0 z-20">
        ...
        <div className="col-span-3">
            <form className='w-full text-sm bg-dryGray rounded flex-btn gap-4'>
                ...
                <input type="text" placeholder='Search Movie Name' className='font-medium placeholder:text-border text-sm w-11/12 h-12 bg-transparent border-none px-2 text-black' />
            </form>
        </div>
        {/* Menus */}
