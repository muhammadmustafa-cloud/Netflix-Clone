...
function NotFound() {
  return (
    <div className='flex-colo gap-8 w-full min-h-screen text-white bg-main lg:py-20 py-10 px-6'>
      <img src="/Images/404.svg" alt="notfound" className='w-full h-96 object-contain' />
      ...
      <Link to="/" className="bg-subMain transitions text-white flex-rows gap-4 font-medium py-3 px-6 hover:text-main rounded-md "> <BiHomeAlt/>Back Home</Link>
    </div>
  )
}
