                ...
                users ? (
                        ...
                        <td className={`${Text}`}>
                            <div className="w-12 p-1 bg-dry border border-border h-12 rounded overflow-hidden">
                                ...
                                <img className='h-full w-full object-cover'
                                    src={`Images/${data.image ? data.image : "user.png"}`} alt={data?.fullName} />
                            </div>
                        </td>
                    ...
                    : (
                        <>
                            ...
                            <td className={`${Text} float-right flex-rows gap-2`}>
                                <button onClick={() => OnEditFunction(data)} className="border border-border bg-dry flex-rows gap-2 text-border rounded py-1 px-2">Edit <FaEdit className='text-green-500' /></button>
                                <button className="bg-subMain text-white rounded flex-colo w-6 h-6"><MdDelete /></button>
                            </td>
                        </>
                    )
