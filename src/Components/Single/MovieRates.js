    ...
    <div className='my-12'>
      ...
      <div className="mt-10 xl:grid flex-colo grid-cols-5 gap-12 bg-dry xs:p-10 py-10 px-2 sm:p-20 rounded">
        ...
        <div className="xl:col-span-2 w-full flex flex-col gap-8">
          ...
          <p className="text-sm leading-7 font-medium text-border">Write a review for this movie. It will be posted on this page.
          Lorem ipsum dolor sit, amet consectetur adipisicing elit. Mollitia nihil culpa tenetur eaque vel, ad amet maxime </p>
              ...
              UsersData.map((user, i)=> (
                <div className="md:grid flex flex-col w-full grid-cols-12 gap-6 bg-dry p-4 border border-gray-800 rounded-lg">
                    <div className="col-span-2 bg-main hidden md:block">
                      <img src={`/Images/${user ? user.image : "user.jpg"}`} alt={user.name} className='w-full h-24 rounded-lg object-cover' />
                    </div>
